...
namespace ToDoUygulamasi
{
    internal class Board
    {
        ...
        public Board()
        {
            kisiler.Add(0, "Muharrem Serdar");
            kisiler.Add(1, "Ismail Har");
            kisiler.Add(2, "Erol B");
            kisiler.Add(3, "Ahmet F");
            kisiler.Add(4, "Mahmet C");

            TODO.Add(new Kart("Temizlik", "Yerleri Supur", "Muharrem Serdar", Kart.Buyuluk.M));
            INPROGRESS.Add(new Kart("Temizlik", "Camlari Sil", "Ismail Har", Kart.Buyuluk.S));
            DONE.Add(new Kart("Spor", "2 Km Kos", "Erol B", Kart.Buyuluk.L));
            DONE.Add(new Kart("Ev", "Alisveris Yap", "Ahmet F", Kart.Buyuluk.XL));
            INPROGRESS.Add(new Kart("Temizlik", "Toz Al", "Mahmet C", Kart.Buyuluk.XS));
        }
